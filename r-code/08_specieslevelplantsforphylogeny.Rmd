...
insecttree_subset <- (get_subtree_with_tips(insecttree, only_tips = insecttipdata_subset$InsectTreeName))$subtree
...
types <- unique(plantinsecttreetable[c("SampleName", "InsectTreeName", "Type")])
